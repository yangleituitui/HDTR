...
class reconstructionLoss(nn.Module):
    ...
    def calculateReconstructionLoss(self, video_pd, video_gt):
        l1_loss_value = self.l1_loss(video_pd, video_gt)
        l2_loss_value = self.l2_loss(video_pd, video_gt)
        reconstruction_loss = l1_loss_value + l2_loss_value
