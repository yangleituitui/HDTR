...
writer = SummaryWriter(log_dir='/home/lcj/Project/yangl/HDTR-Net-main/logs/zynan_xin')
logging.basicConfig(filename='/home/lcj/Project/yangl/HDTR-Net-main/loging/zynan_xin/training.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
#初始化生成器
def load_model(args):
...
def validate_model(generator, discriminator,GAN_Loss,val_dataloader,Perception_Loss, Reconstruction_Loss, gan_weight, perception_weight, reconstruction_weight,epoch):
    ...
    with torch.no_grad():
        for valid_mouth_mask, valid_mouth_contour, valid_reference,val_can in val_dataloader:
            ...
            valid_reference=val_can.to(device)
            generator.to(device)
            predict_data = generator(valid_mouth_mask, valid_mouth_contour, valid_reference)
        ...
        logging.info(f'Epoch {epoch+1},Val_Generator_Loss: {avg_generator_loss}')
...
if __name__=="__main__":
    ...
    parser.add_argument("--dis_save_dir", type=str, default="/home/lcj/Project/18T_another_one/yanglei/HDTR/checkpoint/zynan_xin/dis")
    parser.add_argument("--gen_save_dir", type=str, default="/home/lcj/Project/18T_another_one/yanglei/HDTR/checkpoint/zynan_xin/gen")
    ...
    parser.add_argument("--train_dataset_path", type=str, default="/home/lcj/Project/18T_another_one/yanglei/zynan_mouth/train")
    parser.add_argument("--val_dataset_path", type=str, default="/home/lcj/Project/18T_another_one/yanglei/zynan_mouth/val")
