...
if __name__=="__main__":
    ...
    parser.add_argument('--input_video', type=str, default='/home/lcj/Project/yangl/HDTR-Net-main/sample/ZYnv_tooth_tooth_230.mp4', help='Input video to clear mouth region')
    parser.add_argument('--temp_dir', type=str, default='./test_result', help='Temp directory to save output')
    parser.add_argument('--model_path', type=str, default='/home/lcj/Project/18T_another_one/yanglei/HDTR/checkpoint/zynv_tooth/gen/generator_weights_epoch230.pth', 
